...
class PersonalInfoTableViewController: UITableViewController {
    ...
    @IBAction func SaveUser(_ sender: Any) {
        API.shared.addUser(user: Room(dormitory: "", number: "", age: ageTExt.text ?? "", gender: genderText.text ?? "", nation: nationText.text ?? ""), completion: { self.navigationController?.popViewController(animated: true)})
//
    }
